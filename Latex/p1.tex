...
\begin{tabular}{r| p{0.5\textwidth} c}
    ...
    \cvevent{2023--2024}{Magister en Ciencia de Datos}{Universidad de Chile}{fcfm \color{cvred}}{Actualmente en proceso de defensa de \href{https://github.com/fernando-fetis/mds-thesis}{tesis}, centrada en el estudio de una familia de modelos generativos avanzados, denominada puentes de Schrödinger. Planeo publicar mi trabajo de tesis en revistas especializadas. Durante el programa, adquirí habilidades en análisis de datos, aprendizaje automático y optimización de modelos, aplicadas a resolver problemas complejos en diversas áreas.}{uchile.png} \\
