...
\begin{tabular}{r| p{0.55\textwidth} c}
    ...
    \cvevent{2025}{Investigador}{RIAL}{Santiago \color{cvred}}{También me encuentro trabajando como investigador en la startup RIAL, donde trabajamos con modelos de difusión para generación de imágenes de alta calidad.}{rial.png} \\
